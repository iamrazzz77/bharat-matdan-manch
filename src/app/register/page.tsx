...
import { Vote, UserPlus, CheckCircle, AlertCircle } from "lucide-react";
...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Find constituency ID from database or use default seeded constituency
      const res = await fetch("/api/auth/register", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          ...formData,
          constituencyId: "c1-mumbai-south" // Will resolve to first available or seeded constituency
        })
      });
  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-lg bg-eci-cardBg border border-gray-700/80 rounded-2xl p-8 shadow-2xl space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-gray-400">Register your Elector Photo Identity Card details</p>
        </div>
